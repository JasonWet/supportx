...
exports.run = async (client, message, args) => {
    ...
    let embed = new Discord.MessageEmbed()
        ...
        .setDescription(`[Installation](${links.global.collectorsx.installation})\n[Commands](${links.global.collectorsx.commands})\n[Permissions](${links.global.collectorsx.permissions})\n[Placeholders](${links.global.collectorsx.placeholders})\n[Default Files](${links.global.collectorsx.files})`)
        .setTimestamp()
