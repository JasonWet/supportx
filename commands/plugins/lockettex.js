...
exports.run = async (client, message, args) => {
    ...
    let embed = new Discord.MessageEmbed()
        .setAuthor('LocketteX' + ' : ' + message.author.tag , message.author.avatarURL())
        .setColor(config.embedColor)
        .setDescription(`[Installation](${links.global.lockettex.installation})\n[Commands](${links.global.lockettex.commands})\n[Permissions](${links.global.lockettex.permissions})\n[Placeholders](${links.global.lockettex.placeholders})\n[Default Files](${links.global.lockettex.files})`)
        .setTimestamp()
...
exports.help = {
    name: "lockettex",
    category: "Plugins",
    description: "LocketteX Plugin Information",
    usage: "lockettex"
};